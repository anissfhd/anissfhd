...
Je suis Aniss, étudiant en 5e année d'ingénierie spécialisé en Intelligence Artificielle et Science des Données.
...
Je consacre une grande partie de mon temps à explorer, tester et repousser les limites des dernières innovations en IA pour donner vie à des projets créatifs et inédits, rarement vus en ligne.

Explorez mon portfolio

Je vous invite à parcourir mes projets ci-dessous. Pour chacun d'eux, une courte vidéo de présentation est disponible pour vous donner un aperçu concret des fonctionnalités et de la valeur ajoutée de l'application.
